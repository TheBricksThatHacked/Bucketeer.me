...
def user_profile(request, user_id=None):
    ...
    return render_to_response("profile.html", {'percentUnCompleted': percentUnCompleted,'percentCompleted': percentCompleted, 'userProfile': user.profile, 'email_hash': email_hash, 'user_items': user_items, 'items_completed': items_completed}, context_instance=RequestContext(request))
